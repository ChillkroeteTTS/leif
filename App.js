...
import RadialCounter from "./src/components/RadialCounter";

class MinuteSelector extends Component<Props> {
...
export default class App extends Component<Props> {
    render() {
        return (
            <View style={{flexDirection: "row", backgroundColor: '#f0f5f8', height: "100%",
